...
public class KettleDataContextTest extends TestCase {
  ...
  public void testReadSimpleFile() throws Exception {
    KettleDataContext dc = new KettleDataContext(
        "src-test/simple_name_and_age_data.kettlestream");

    assertEquals("[information_schema, hmm]",
    ...
    assertEquals("Table[name=Data Grid,type=TABLE,remarks=null]",
        table.toString());
